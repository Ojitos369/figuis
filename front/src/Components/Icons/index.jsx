...
// -----------------------------------   ANIMATED   ----------------------------------- //
export const AnimateEdit = props => {
...
export const AnimateRemove = props => {
...
export const ArrowLeft = ({ size = 24, color = "currentColor", className = "", ...props }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
            ...
            strokeLinejoin="round"
            className={className}
            {...props} // Permite pasar props adicionales como onClick, aria-label, etc.
        >
            {/* El dibujo de la flecha apuntando a la izquierda */}
            <path d="M15 18l-6-6 6-6" />
        </svg>
    );
};

export const ArrowRight = ({ size = 24, color = "currentColor", className = "", ...props }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
            ...
            {...props} // Permite pasar props adicionales como onClick, aria-label, etc.
        >
            {/* El dibujo de la flecha apuntando a la derecha */}
...
export const Copy = ({ size = 24, color = "currentColor", className = "", ...props }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
...
export const Info = ({ size = 24, color = "currentColor", className = "", ...props }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width={size}
